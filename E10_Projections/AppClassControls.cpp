...
#pragma endregion
	...
	{
		m_m4Projection = glm::perspective(45.0f, 333.0f / 1598.0f, 0.01f, 1000.0f);
		m_m4View = glm::lookAt(glm::vec3(90.0f, 0.0f, 0.0f), glm::vec3(14.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	}
