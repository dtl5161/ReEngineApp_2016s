...
BoundingSphereClass::MyBoundingSphereClass(std::vector<vector3> vertexList)
{
	m_bColliding = false;
	m_fRadius = 0.0f;
	...
	m_v3Size.x = glm::distance(vector3(v3Min.x, 0.0, 0.0), vector3(v3Max.x, 0.0, 0.0));
	m_v3Size.y = glm::distance(vector3(0.0, v3Min.y, 0.0), vector3(0.0, v3Max.y, 0.0));
	m_v3Size.z = glm::distance(vector3(0.0, 0.0, v3Min.z), vector3(0.0, 0.0, v3Max.z));
}

void BoundingSphereClass::RenderSphere()
{
...
void BoundingSphereClass::SetModelMatrix(matrix4 a_m4ToWorld)
{
...
bool BoundingSphereClass::IsColliding(MyBoundingSphereClass* a_other)
{
